...
${HOME}/services/datastore/operations/DeleteFromDatastore.sh "scaling" "*autoscaler-${no_autoscaler}*/STATIC_SCALE*" "local" "scaling-${CLOUDHOST}-${REGION}"
${HOME}/services/datastore/operations/PutToDatastore.sh "scaling" "${HOME}/runtime/scaling/STATIC_SCALE:${new_scale_value}" "autoscaler-${no_autoscaler}" "local" "no" "scaling-${CLOUDHOST}-${REGION}"

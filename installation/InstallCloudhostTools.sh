...
then
	...
	${HOME}/installation/InstallDoctl.sh ${BUILDOS}
...
then
	...
	${HOME}/installation/InstallExo.sh ${BUILDOS}
...
then
	...
	${HOME}/installation/InstallLinodeCLI.sh ${BUILDOS}
...
then
	...
	${HOME}/installation/InstallVultr.sh ${BUILDOS}

...
delete_marked_files()
{
        ...
        do
                ...
                ${HOME}/services/datastore/operations/DeleteFromDatastore.sh "${bucket_type}" "${datastore_marker_file}" "local" 
                ${HOME}/services/datastore/operations/DeleteFromDatastore.sh "${bucket_type}" "${datastore_real_file}" "local" 
        done
}
...
update_to_and_from_datastore()
{
        ...
        do
                ...
                then
                        ...
                        do
                                ${HOME}/services/datastore/operations/PutToDatastore.sh "${bucket_type}" "${file_to_add}" "${place_to_put}" "local" "no"
                        done
                        fi
